  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div
            className="relative overflow-hidden rounded-xl p-0.5 max-w-3xl mx-auto"
            style={{ background: "linear-gradient(135deg, #F200B8, #9333ea, #F200B8)" }}
          >
            <div className="relative bg-white dark:bg-gray-900 rounded-xl overflow-hidden flex flex-col sm:flex-row items-stretch">
              <div className="sm:w-40 md:w-48 flex-shrink-0 bg-black">
                <img
              ...
              <div className="flex-1 p-4 md:p-5 flex flex-col justify-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-3 line-clamp-3">
                  ...
                  l'Antiquité aux révolutions actuelles du deep learning.
                </p>
                <div className="flex flex-wrap items-center gap-3">
                  <a
                    ...
                    className="flex items-center font-semibold gap-1 text-sm transition-all hover:gap-2"
                    style={{ color: "#F200B8" }}
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-white font-semibold text-xs transition-all hover:scale-105 hover:shadow-md"
