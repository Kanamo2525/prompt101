        ...
        <TabsContent value="all" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Résume l'article suivant en 3-5 points clés, en conservant les informations essentielles et en
                  éliminant les détails superflus.
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Crée un plan d'apprentissage détaillé pour maîtriser [sujet] en [durée]. Inclus des ressources, des
                  étapes progressives et des objectifs mesurables.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Propose 10 idées créatives et innovantes pour [projet/problème]. Assure-toi que les idées soient
                  variées, réalisables et originales.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Explique [concept complexe] comme si tu parlais à un enfant de 10 ans. Utilise des analogies simples
