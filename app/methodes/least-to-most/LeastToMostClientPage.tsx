...
export default function LeastToMostClientPage() {
  const [activeTab, setActiveTab] = useState("description")

  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      {/* Hero Section with White Background */}
      <div className="bg-white rounded-xl p-8 mb-10 shadow-sm border-b">
        <div className="text-center">
          <span className="inline-block px-3 py-1 text-xs font-semibold bg-red-500 text-white rounded-full mb-4">
            Niveau : Avancé
          </span>
          <h1 className="text-4xl font-bold mb-4 text-gray-800">Least-to-Most Prompting</h1>
      ...
      <Tabs defaultValue="description" value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        {/* Examples Tab */}
        <TabsContent value="exemples" className="space-y-8">
          <section className="mb-12">
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-md mb-4">
                    ...
                    <ul className="list-disc pl-5 mb-2">
                      ...
                      <li>
                        <strong>Valorisation</strong> : Récupérer l&apos;énergie des déchets qui ne peuvent être
                        recyclés
                      </li>
                    </ul>
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-md mb-4">
                    ...
                    <ol className="list-decimal pl-5 mb-2 space-y-2">
                      <li>
                        <strong>Éco-conception industrielle</strong> : conception modulaire, réduction de la diversité
                        des matériaux, substitution des substances dangereuses
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Production optimisée</strong> : efficacité énergétique, réutilisation des chutes,
                        boucles fermées pour l&apos;eau
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Fin de vie repensée</strong> : reconditionnement, récupération des composants,
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    Les étapes suivantes continuent d&apos;augmenter la complexité, avec l&apos;analyse des opportunités
                    et défis (étape 3), puis l&apos;élaboration d&apos;une feuille de route stratégique complète sur 3
                    ans (étape 4).
                  </p>
                </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="bg-gray-100 p-4 rounded-md">
                      <p className="mb-2">
                        ...
                        d&apos;équipements industriels de taille moyenne souhaitant transformer son modèle
                        d&apos;affaires vers l&apos;économie circulaire.
                      </p>
                      <p>
                        <strong>Problème :</strong> La réponse risque de manquer de contexte approfondi sur
                        l&apos;économie circulaire et ses applications spécifiques.
                      </p>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="bg-gray-100 p-4 rounded-md">
                      ...
                      <p>
                        <strong>Avantage :</strong> Cette progression graduelle permet d&apos;obtenir une feuille de
                        route plus riche et applicable.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* Use Cases Tab */}
        <TabsContent value="cas-usage" className="space-y-8">
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="mb-3">
                  Idéal pour décomposer une analyse de marché ou d&apos;opportunité d&apos;affaires en étapes
                  progressives.
                </p>
                <div className="bg-gray-100 p-4 rounded-md text-sm">
                  ...
                  <p className="mb-2">
                    <strong>Étape 2 :</strong> &quot;Sur la base de ces tendances, identifie les segments de marché les
                    plus prometteurs et les moins saturés dans ce secteur.&quot;
                  </p>
                  <p className="mb-2">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="bg-gray-100 p-4 rounded-md text-sm">
                  <p className="mb-2">
                    <strong>Étape 1 :</strong> &quot;Quels sont les principes fondamentaux d&apos;une organisation agile
                    et comment se différencie-t-elle d&apos;une structure traditionnelle ?&quot;
                  </p>
                  <p className="mb-2">
                    <strong>Étape 2 :</strong> &quot;Quels sont les principaux obstacles et résistances typiques
                    rencontrés lors d&apos;une transformation vers l&apos;agilité organisationnelle ?&quot;
                  </p>
                  <p className="mb-2">
                    <strong>Étape 3 :</strong> &quot;Identifie les compétences clés et les changements culturels
                    nécessaires pour réussir cette transformation dans une entreprise du secteur industriel.&quot;
                  </p>
                  <p>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="mb-3">
                  Facilite l&apos;analyse progressive de l&apos;impact d&apos;une nouvelle réglementation sur les
                  opérations de l&apos;entreprise.
                </p>
                <div className="bg-gray-100 p-4 rounded-md text-sm">
                  <p className="mb-2">
                    <strong>Étape 1 :</strong> &quot;Explique les principales dispositions du nouveau règlement européen
                    sur la cybersécurité des produits connectés (Cyber Resilience Act).&quot;
                  </p>
                  <p className="mb-2">
                  ...
                  <p className="mb-2">
                    <strong>Étape 3 :</strong> &quot;Analyse les écarts entre nos pratiques actuelles de développement
                    et de sécurité et les exigences de cette nouvelle réglementation.&quot;
                  </p>
                  <p>
                    <strong>Étape 4 :</strong> &quot;Développe un plan de mise en conformité complet, incluant les
                    modifications requises dans nos processus, les compétences à acquérir, et une estimation des coûts
                    et délais de mise en œuvre.&quot;
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <ul className="space-y-2 pl-5 list-disc">
                ...
                <li>
                  <strong>Assurez-vous que chaque étape s&apos;appuie</strong> sur les informations obtenues à
                  l&apos;étape précédente
                </li>
                <li>
