          ...
          <div>
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-2">
                <div
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${promptType === "automatisation" ? "bg-blue-100 border-blue-500" : "border-gray-300 hover:bg-gray-50"}`}
                ...
                <div
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${promptType === "transformation" ? "bg-purple-100 border-purple-500" : "border-gray-300 hover:bg-gray-50"}`}
                ...
                <div
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${promptType === "maintien" ? "bg-amber-100 border-amber-500" : "border-gray-300 hover:bg-gray-50"}`}
                ...
                <div
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${promptType === "augmentation" ? "bg-green-100 border-green-500" : "border-gray-300 hover:bg-gray-50"}`}
