...
interface TimeManagementPromptCardProps {
  prompt: Prompt
}

export function TimeManagementPromptCard({ prompt }: TimeManagementPromptCardProps) {
  return (
    <Link href={`/categories/time-management/${prompt.id}`}>
